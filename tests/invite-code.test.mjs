...
test('invite page exposes copy guidance and the verified macOS download', async () => {
  ...
  assert.match(page, /下载 macOS App 0\.4\.11/)
  assert.match(page, /https:\/\/api\.kimidance\.com\/downloads\/Kimidance-Mac-0\.4\.11-arm64\.dmg/)
  ...
  assert.match(built, /下载 macOS App 0\.4\.11/)
  assert.match(built, /https:\/\/api\.kimidance\.com\/downloads\/Kimidance-Mac-0\.4\.11-arm64\.dmg/)
